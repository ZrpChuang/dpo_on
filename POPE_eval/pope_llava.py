...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/data/ruipeng.zhang/dpo_on/output/llava_lora_r128_att")
    ...
    parser.add_argument("--answers-file", type=str, default="/data/ruipeng.zhang/dpo_on/POPE_eval/llava_att_r128/coco_adversarial.jsonl") #这个是输出
