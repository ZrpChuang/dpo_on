...
MODEL_PATH="/data/ruipeng.zhang/dpo_on/output/llava_lora_r64_vcd"
OUTPUT_FILE="/data/ruipeng.zhang/dpo_on/AMBER_eval/AMBER_output/AMBER_llava_responses_vcd_r64.jsonl"
